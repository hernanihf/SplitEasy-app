...
const translations = {
  en: {
    ...
    scanReceipt: {
      ...
      title: 'Scan receipt',
      description: 'Take a photo or upload an image or PDF and AI will fill in the expense.',
  ...
  es: {
    ...
    scanReceipt: {
      ...
      description: 'Sacá una foto o subí una imagen o PDF y la IA completa el gasto.',
