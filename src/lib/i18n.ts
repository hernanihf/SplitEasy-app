...
const translations = {
  en: {
    ...
    scanReceipt: {
      ...
      title: 'Scan receipt',
      description: 'Take a photo or upload an image or PDF of the receipt and AI will fill in the expense for you.',
  ...
  es: {
    ...
    scanReceipt: {
      ...
      description: 'Sacá una foto o subí una imagen o PDF del ticket y la IA va a completar el gasto por vos.',
