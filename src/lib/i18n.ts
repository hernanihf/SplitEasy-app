...
const translations = {
  en: {
    ...
    activity: {
      ...
      settledIn: 'in %{group}',
      commentedOn: '%{name} commented on %{title} · %{group}',
    ...
    groupDetail: {
      ...
      statsFilterRange: 'Range',
      statsFrom: 'From',
      statsTo: 'To',
      statsRangeInvalid: '"From" must be before "to".',
      exportSpending: 'Export as Excel',
      exportSpendingError: "Couldn't export this.",
      ...
      exportError: "Couldn't export this group.",
    ...
    itemize: {
      ...
      addItem: '+ Add item',
      adjustments: 'Extra adjustments (tips, discounts)',
      adjustmentsEmpty: 'Add a discount, tip, or fee here if it changes the total.',
      addAdjustment: '+ Add adjustment',
      perPerson: 'Per person',
      confirm: 'Add expense',
      assignAll: 'Everything needs at least one person assigned.',
      itemsInvalid: 'Every item needs a description and an amount greater than 0.',
      adjustmentsInvalid: 'Every adjustment needs a description and a non-zero amount.',
    },
    expenseDetail: {
  ...
  es: {
    ...
    activity: {
      ...
      settledIn: 'en %{group}',
      commentedOn: '%{name} comentó en %{title} · %{group}',
    ...
    groupDetail: {
      ...
      statsFilterMonth: 'Mes',
      statsFilterRange: 'Rango',
      statsFrom: 'Desde',
      statsTo: 'Hasta',
      statsRangeInvalid: '"Desde" debe ser anterior a "hasta".',
      exportSpending: 'Exportar como Excel',
      exportSpendingError: 'No se pudo exportar esto.',
    ...
    itemize: {
      ...
      adjustments: 'Ajustes extra (propinas, descuentos)',
      adjustmentsEmpty: 'Agregá acá un descuento, propina o cargo si cambia el total.',
      addAdjustment: '+ Agregar ajuste',
      perPerson: 'Por persona',
      confirm: 'Agregar gasto',
      assignAll: 'Todo necesita al menos una persona asignada.',
      itemsInvalid: 'Cada ítem necesita una descripción y un monto mayor a 0.',
      adjustmentsInvalid: 'Cada ajuste necesita una descripción y un monto distinto de cero.',
    },
    expenseDetail: {
